  ...
  function handleFormSubmit(event) {
    ...
    axios
      ...
      .then(function (response) {
        ...
        const customerReportsBody = document.getElementById('customer-reports-body');
...
function exportToExcel() {
  const reportsTableHeders=document.getElementById("customer-reports-headers")
  const reportsTable = document.getElementById('customer-reports-body');
  const startDate = document.getElementById('startDate').value;
  const endDate = document.getElementById('endDate').value;

  const headers = Array.from(reportsTableHeders.querySelectorAll('th')).map((header) => header.innerText);
